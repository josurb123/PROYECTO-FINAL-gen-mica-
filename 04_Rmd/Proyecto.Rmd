...
Al determinar un umbral de valores aceptados, generamos a su vez un filtro de calidad ya que muchas bacterias van a tener relaciones debiles o insignificantes, al no eliminarlas, generamos un ruido de fondo.
Por esa razon, nos quedamos con interacciones verdaderas
```{r}
